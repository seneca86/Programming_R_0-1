...
* __The class will be graded__, but this grade will not be part of the official academic records

* As a consequence, I will keep __homework shorter than for Programming I and II__, but there will be still some

* For the homework, it is recommended that you __form groups via Blackboard__

* If you cannot find __teammates__ for for a group, you can ask me to assign you to a group randomly

* You can also work __alone__ if you prefer

* The __weights__ of homework, in-class quizzes and attendance on the grade will be 30-20-50

* In the __quizzes__, you will get some credit as long as you fill them out

* I have set up __office hours__ right after the class for those of you who have questions — you will see these on the calendar

* Based on your preferences, today we are having this class in __hybrid format__ and will probably keep doing so (depending on your feedback and on classroom availability)

![Grades structure](Figures/grades_structure.png)

![Office hours](Figures/office_hours.png)
...
![Algebra refresher (1/2)](Figures/algebra_1.png)

![Algebra refresher (2/2)](Figures/algebra_2.png)
...
![Please fill out the poll](Figures/poll.jpeg){width=30%}
...
![It will take us a bit longer](Figures/neo.jpeg){width=50%}
...
![We will cover lists and proceed to forget about them](Figures/escobar.jpeg){width=50%}
...
![Please fill out the poll](Figures/poll.jpeg){width=40%}
...
![Soon we will be using dataframes more than any other type of variable](Figures/dust_doge.jpeg){width=50%}
